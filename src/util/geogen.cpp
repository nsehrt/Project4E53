...
GeoGenerator::MeshData GeoGenerator::createBoxMesh(float width, float height, float depth, unsigned int numSubdivisions)
{
	MeshData meshData;
...
GeoGenerator::MeshData GeoGenerator::createSphereMesh(float radius, unsigned int sliceCount, unsigned int stackCount)
{
	MeshData meshData;
...
GeoGenerator::MeshData GeoGenerator::createFullscreenQuad(float x, float y, float w, float h, float depth)
{
	MeshData meshData;
...
GeoGenerator::MeshData GeoGenerator::createGeosphere(float radius, unsigned int numSubdivisions)
{
	MeshData meshData;
...
GeoGenerator::MeshData GeoGenerator::createGrid(float width, float depth, unsigned int m, unsigned int n)
{
	MeshData meshData;
...
void GeoGenerator::Subdivide(MeshData& _meshData)
{
	...
	unsigned int numTris = (unsigned int)inputCopy.Indices32.size() / 3;
...
GeoGenerator::Vertex GeoGenerator::MidPoint(const Vertex& v0, const Vertex& v1)
{
