...
json LightObject::toJson()
{
    json lJson;

    lJson["Name"] = name;
    lJson["FallOffStart"] = getFallOffStart();
    lJson["FallOffEnd"] = getFallOffEnd();
    lJson["Position"] = { getPosition().x, getPosition().y, getPosition().z };
    lJson["Strength"] = { getStrength().x, getStrength().y, getStrength().z };
